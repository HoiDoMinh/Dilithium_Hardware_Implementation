...
int main(void) {
    ...
    unsigned int i;
    strcpy((char*)m, "CHUYEN KHOAN 1000USD CHO ALICE");
    strcpy((char*)pre, "BANKING");
    uint8_t rnd[32] = {
    ...
    if(ret == 0) printf("Signature generated successfully.\n");
    else printf("Sign failed with code: %d\n", ret);
