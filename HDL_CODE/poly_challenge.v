module poly_challenge #(
    ...
    input                       reset,
    input                       start,
    input  [CTILDEBYTES*8-1:0]  seed_in,
    ...
    reg [7:0]  buffer   [0:SHAKE256_RATE-1];
    reg [63:0] signs;
    reg [7:0]  pos;
    reg [8:0]  i_idx;
    reg [7:0]  b;
    ...
    always @(*) begin
        ...
        case (state)
            ...
            // ============================================
            // FIX: T? ??ng chuy?n sang RD_INP
            // ============================================
            PRE_RD_INP: begin
                next_state = RD_INP;  // ? S?A: Không ch? start
            end
    ...
    always @(posedge clock or posedge reset) begin
        if (reset) begin
            ...
            case (state)
                ...
                PRE_RD_INP: begin
                    // ? S?A: Luôn init, không c?n ki?m tra start
                    state_s_reg   <= init_s;
                    state_pos_reg <= init_pos;
                end
